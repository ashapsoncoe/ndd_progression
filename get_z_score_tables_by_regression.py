...
experiment_name = '8_august_2023_age_TIV_centre_grouped_regions_onlyage2_sep_sex'
save_dir = 'D:\\acf_work'
input_data_path = 'D:\\acf_work\\UKBW_EBM_78867r672482_070823.csv'
...
groupings = {
    ...
    'brainstem': ['volume_of_grey_matter_in_brainstem_f25892_2_0'],
...
brain_regions_to_use = [
    ...
    # volume_of_grey_matter_in_x_cerebellum_vermis_f25919_2_0
    # volume_of_grey_matter_in_x_cerebellum_right_f25920_2_0
    # volume_of_av_left_hemisphere_f26684_2_0
    # volume_of_av_right_hemisphere_f26710_2_0
    # volume_of_accessorybasalnucleus_left_hemisphere_f26602_2_0
    # volume_of_accessorybasalnucleus_right_hemisphere_f26612_2_0
    # volume_of_anterioramygdaloidareaaaa_left_hemisphere_f26603_2_0
    # volume_of_anterioramygdaloidareaaaa_right_hemisphere_f26613_2_0
    # volume_of_basalnucleus_left_hemisphere_f26601_2_0
    # volume_of_basalnucleus_right_hemisphere_f26611_2_0
    # volume_of_cl_left_hemisphere_f26681_2_0
    # volume_of_cl_right_hemisphere_f26706_2_0
    # volume_of_cm_left_hemisphere_f26670_2_0
    # volume_of_cm_right_hemisphere_f26694_2_0
    # volume_of_cem_left_hemisphere_f26677_2_0
    # volume_of_cem_right_hemisphere_f26703_2_0
    # volume_of_centralnucleus_left_hemisphere_f26604_2_0
    # volume_of_centralnucleus_right_hemisphere_f26614_2_0
    # volume_of_corticalnucleus_left_hemisphere_f26606_2_0
    # volume_of_corticalnucleus_right_hemisphere_f26616_2_0
    # volume_of_corticoamygdaloidtransitio_left_hemisphere_f26607_2_0
    # volume_of_corticoamygdaloidtransitio_right_hemisphere_f26617_2_0
    # volume_of_hata_left_hemisphere_f26638_2_0
    # volume_of_hata_right_hemisphere_f26660_2_0
    # volume_of_lsg_left_hemisphere_f26668_2_0
    # volume_of_lsg_right_hemisphere_f26692_2_0
    # volume_of_ld_left_hemisphere_f26712_2_0
    # volume_of_ld_right_hemisphere_f26713_2_0
    # volume_of_lgn_left_hemisphere_f26665_2_0
    # volume_of_lgn_right_hemisphere_f26688_2_0
    # volume_of_lp_left_hemisphere_f26687_2_0
    # volume_of_lp_right_hemisphere_f26711_2_0
    # volume_of_lateralnucleus_left_hemisphere_f26600_2_0
    # volume_of_lateralnucleus_right_hemisphere_f26610_2_0
    # volume_of_mdl_left_hemisphere_f26676_2_0
    # volume_of_mdl_right_hemisphere_f26700_2_0
    # volume_of_mdm_left_hemisphere_f26673_2_0
    # volume_of_mdm_right_hemisphere_f26697_2_0
    # volume_of_mgn_left_hemisphere_f26664_2_0
    # volume_of_mgn_right_hemisphere_f26689_2_0
    # volume_of_mvre_left_hemisphere_f26679_2_0
    # volume_of_mvre_right_hemisphere_f26702_2_0
    # volume_of_medialnucleus_left_hemisphere_f26605_2_0
    # volume_of_medialnucleus_right_hemisphere_f26615_2_0
    # volume_of_medulla_whole_brain_f26716_2_0
    # volume_of_midbrain_whole_brain_f26719_2_0
    # volume_of_paralaminarnucleus_left_hemisphere_f26608_2_0
    # volume_of_paralaminarnucleus_right_hemisphere_f26618_2_0
    # volume_of_pc_left_hemisphere_f26685_2_0
    # volume_of_pc_right_hemisphere_f26708_2_0
    # volume_of_pf_left_hemisphere_f26674_2_0
    # volume_of_pf_right_hemisphere_f26698_2_0
    # volume_of_pons_whole_brain_f26717_2_0
    # volume_of_pt_left_hemisphere_f26683_2_0
    # volume_of_pt_right_hemisphere_f26709_2_0
    # volume_of_pua_left_hemisphere_f26672_2_0
    # volume_of_pua_right_hemisphere_f26696_2_0
    # volume_of_pui_left_hemisphere_f26666_2_0
    # volume_of_pui_right_hemisphere_f26690_2_0
    # volume_of_pul_left_hemisphere_f26682_2_0
    # volume_of_pul_right_hemisphere_f26705_2_0
    # volume_of_pum_left_hemisphere_f26667_2_0
    # volume_of_pum_right_hemisphere_f26691_2_0
    # volume_of_scp_whole_brain_f26718_2_0
    # volume_of_va_left_hemisphere_f26678_2_0
    # volume_of_va_right_hemisphere_f26701_2_0
    # volume_of_vamc_left_hemisphere_f26675_2_0
    # volume_of_vamc_right_hemisphere_f26699_2_0
    # volume_of_vla_left_hemisphere_f26671_2_0
    # volume_of_vla_right_hemisphere_f26695_2_0
    # volume_of_vlp_left_hemisphere_f26686_2_0
    # volume_of_vlp_right_hemisphere_f26707_2_0
    # volume_of_vm_left_hemisphere_f26680_2_0
    # volume_of_vm_right_hemisphere_f26704_2_0
    # volume_of_vpl_left_hemisphere_f26669_2_0
    # volume_of_vpl_right_hemisphere_f26693_2_0
    # volume_of_fimbria_left_hemisphere_f26636_2_0
    # volume_of_fimbria_right_hemisphere_f26658_2_0
]
...
def plot_and_save_scatter(xs, ys, xlab, ylab, save_path, fname, draw_xy_line=False, draw_horizonal_line=False, s=0.1):
...
def fit_and_save_models_for_all_regions(brain_regions_to_use, controls_df, regression_model_type):
    ...
    for brain_region in brain_regions_to_use:
        ...
        # for poly_degree in range(1, polynomial_features_degree+1):
...
def plot_residuals_vs_fitted_y_and_covariates(brain_regions_to_use, fitted_model_dict, save_dir, controls_df, all_covariates): #, chunks = 100, var_smoothing_sigma=0):
    ...
    for brain_region in brain_regions_to_use:
        ...
        for var in continous_explanatory_variables + ['fitted_Y']:
            ...
            for resid_type in resid_types:
                ...
                plot_and_save_scatter(to_plot, resid_types[resid_type], var, f'{resid_type} residuals', save_path_resid, f_name, draw_horizonal_line=True)
...
def fit_linear_models_to_control_data(regression_model_type, control_df_subsets, controls_df, brain_regions_to_use, save_dir, categorical_explanatory_variables, variables_for_separate_models, continous_explanatory_variables, all_covariates):
    ...
    for combo_type in control_df_subsets:
        ...
        plot_residuals_vs_fitted_y_and_covariates(brain_regions_to_use, fitted_model_dict, subset_save_dir, subset_df, all_covariates)
...
if __name__ == '__main__':
    ...
    save_dir = make_save_dir(save_dir, experiment_name, regression_model_type, polynomial_features_degree)
    ...
    controls_z_score_df = get_z_scores(controls_df, brain_regions_to_use, fitted_models, all_covariates)
    cases_z_score_df = get_z_scores(dementia_df, brain_regions_to_use, fitted_models, all_covariates)


    controls_z_score_df.to_csv(f'{save_dir}\\all_controls_{len(brain_regions_to_use)}_regions_z_scores.csv')
